...
CORPORATE_ENV_VARS = [
    ...
    "BRADESCO_TEXT_MODEL", "BRADESCO_TEXT_TEMPERATURE", "BRADESCO_TEXT_MAX_TOKENS",
    "BRADESCO_PROMPT_MAX_CHARS", "EXTRACTION_MAX_PAGES_PER_TASK",
    "EXTRACTION_FALLBACK_PAGES_PER_DOCUMENT", "EXTRACTION_MAX_ATTEMPTS",
    "EXTRACTION_RETRY_DELAY_SECONDS", "EXTRACTION_LEASE_SECONDS",
