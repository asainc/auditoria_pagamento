...
export type CalculationRequest = { "origem_calculo": "manual" | "processo"; "numero_processo"?: string | null; "parcelas": Array<Installment_Input>; "parametros": CalculationParameters_Input; "eventos_financeiros"?: Array<FinancialEvent_Input>; "revisao_humana_confirmada": true; "honorarios_sobre_danos_morais"?: boolean; "competencia_automatica"?: boolean };
...
export type ChronologyDecision = { "campo": string; "valor": string | number | number | boolean | null; "documento": string; "pagina": number; "sequencia": number; "natureza": "pedido" | "fato" | "comando_decisorio" | "fundamentacao" | "classificacao_documental" | "evento_comprovado" | "indeterminado"; "efeito": "informa" | "mantem" | "altera" | "afasta" | "majora" | "reduz" | "substitui" | "nao_se_aplica"; "motivo": string };
...
export type FinancialEvent_Input = { "tipo": "deposito_judicial" | "pagamento_parcial" | "compensacao" | "levantamento"; "data"?: string | null; "valor": number | string; "criterio": "abater_na_data_do_pagamento" | "descontar_no_final" | "informativo"; "indice_atualizacao"?: string | null; "aplicar_juros_apos_evento"?: boolean };

export type FinancialEvent_Output = { "tipo": "deposito_judicial" | "pagamento_parcial" | "compensacao" | "levantamento"; "data"?: string | null; "valor": string; "criterio": "abater_na_data_do_pagamento" | "descontar_no_final" | "informativo"; "indice_atualizacao"?: string | null; "aplicar_juros_apos_evento"?: boolean };
